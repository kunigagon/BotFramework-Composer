...
namespace Microsoft.Bot.Builder
{
    public class MyStorage : IStorage
    {
        ...
        public MyStorage(Dictionary<string, JObject> dictionary = null)
        {
            Console.WriteLine("Initializing new memory storage");
        ...
        public Task WriteAsync(IDictionary<string, object> changes, CancellationToken cancellationToken)
        {
            ...
            lock (_syncroot)
            {
                foreach (var change in changes)
                {
                    ...
                    Console.Write("Writing key: " + change.Key + "; Val: " + newState);
